import{f as U,dZ as c,r as a,h as i,dv as r,j as o,dk as g,L as B,aB as V}from"./index-CAgFUUQ2-1781608806479.js";const M=()=>{U();const[n]=c.useForm(),[d,m]=a.useState(""),[u,j]=a.useState(!0),[f,k]=a.useState(!1),[w,C]=a.useState(null),[h,p]=a.useState(""),[x,q]=a.useState(""),[s,y]=a.useState(""),[b,v]=a.useState(""),[N,F]=a.useState(""),T=a.useMemo(()=>({toolbar:[[{header:[1,2,3,4,5,6,!1]}],[{font:[]}],[{size:[]}],["bold","italic","underline","strike","blockquote"],[{list:"ordered"},{list:"bullet"},{indent:"-1"},{indent:"+1"}],["link","image","video"],[{align:[]}],[{color:[]},{background:[]}],["clean"]],clipboard:{matchVisual:!1}}),[]),S=["header","font","size","bold","italic","underline","strike","blockquote","list","bullet","indent","link","image","video","align","color","background"];a.useEffect(()=>{(async()=>{try{const t=await i.get("/api/terms");if(t.data.length>0){const l=t.data[0];m(l.termsCondition),C(l._id),n.setFieldsValue({termsCondition:l.termsCondition}),k(!0)}}catch{r.error("Failed to fetch terms and conditions data")}finally{j(!1)}})(),I()},[]);const I=async()=>{try{const e=await i.get("/api/pageHeading/heading?pageType=terms-condition"),{heading:t,subheading:l,photo:P,alt:L,imgTitle:R}=e.data;p(t||""),q(l||""),y(P||""),v(L||""),F(R||"")}catch(e){console.error("Failed to fetch headings:",e),r.error("Failed to load page headings")}},E=e=>{(!e||e==="<p><br></p>")&&d&&d!=="<p><br></p>"||(m(e),n.setFieldsValue({termsCondition:e}))},H=async()=>{try{const e=n.getFieldValue("termsCondition")||d,t={termsCondition:e};if(!e||e.replace(/<[^>]*>/g,"").trim()===""){r.error("Terms and conditions content cannot be empty");return}f?(await i.put(`/api/terms/${w}`,t),r.success("Terms and conditions updated successfully")):(await i.post("/api/terms/add",t),r.success("Terms and conditions created successfully"))}catch(e){r.error("Failed to save terms and conditions"),console.error("Error:",e)}},z=async()=>{const e=new FormData;e.append("heading",h),e.append("subheading",x),e.append("alt",b),e.append("imgTitle",N),s instanceof File&&e.append("photo",s);try{await i.put("/api/pageHeading/updateHeading?pageType=terms-condition",e,{withCredentials:!0}),r.success("Page heading updated successfully!")}catch(t){console.error("Failed to update page heading:",t),r.error("Failed to update page heading")}},D=e=>{y(e.target.files[0])};return o.jsxs(o.Fragment,{children:[o.jsxs(g,{className:"mb-4",children:[o.jsx(g.Item,{children:o.jsx(B,{to:"/dashboard",children:"Dashboard"})}),o.jsx(g.Item,{children:"Terms and Conditions Form"})]}),o.jsxs("div",{className:"mb-8 border border-gray-200 shadow-lg p-4 rounded ",children:[o.jsx("h3",{className:"text-lg font-semibold mb-4",children:"Edit Page Heading"}),o.jsxs("div",{className:"grid md:grid-cols-2 md:gap-6 grid-cols-1",children:[o.jsxs("div",{className:"mb-6",children:[o.jsx("label",{className:"block text-gray-700 font-bold mb-2 uppercase font-serif",children:"Heading"}),o.jsx("input",{type:"text",value:h,onChange:e=>p(e.target.value),className:"w-full px-4 py-2 border rounded-md focus:outline-none focus:border-blue-500 transition duration-300"})]}),o.jsxs("div",{className:"mb-6",children:[o.jsx("label",{className:"block text-gray-700 font-bold mb-2 uppercase font-serif",children:"Sub heading"}),o.jsx("input",{type:"text",value:x,onChange:e=>q(e.target.value),className:"w-full px-4 py-2 border rounded-md focus:outline-none focus:border-blue-500 transition duration-300"})]}),o.jsxs("div",{className:"mb-6",children:[o.jsx("label",{className:"block text-gray-700 font-bold mb-2 uppercase font-serif",children:"Upload Image"}),o.jsx("input",{type:"file",onChange:D,className:"w-full px-4 py-2 border rounded-md focus:outline-none focus:border-blue-500 transition duration-300"}),s&&o.jsx("div",{className:"mt-2",children:o.jsx("img",{src:s instanceof File?URL.createObjectURL(s):`/api/logo/download/${s}`,alt:b,className:"w-32 h-32 object-cover rounded"})})]}),o.jsxs("div",{className:"mb-6",children:[o.jsx("label",{className:"block text-gray-700 font-bold mb-2 uppercase font-serif",children:"Alt Text"}),o.jsx("input",{type:"text",value:b,onChange:e=>v(e.target.value),className:"w-full px-4 py-2 border rounded-md focus:outline-none focus:border-blue-500 transition duration-300"})]})]}),o.jsx("button",{onClick:z,className:"px-4 py-2 bg-[#ffd333] text-[#1a1a1a] rounded hover:bg-[#edc32f] transition duration-300 font-serif font-semibold",children:"Save Headings"})]}),o.jsxs(c,{form:n,layout:"vertical",onFinish:H,children:[o.jsx(c.Item,{name:"termsCondition",label:"Terms and Conditions",rules:[{required:!0,message:"Please enter the terms and conditions"},{validator:(e,t)=>{const l=t==null?void 0:t.replace(/<[^>]*>/g,"").trim();return!l||l===""?Promise.reject("Please enter the terms and conditions"):Promise.resolve()}}],children:o.jsx(V,{theme:"snow",value:d,onChange:E,modules:T,formats:S,placeholder:"Start typing your terms and conditions...",style:{height:"400px",marginBottom:"50px"}})}),o.jsxs(c.Item,{children:[o.jsx("button",{type:"submit",disabled:u,className:"px-6 py-2 bg-[#ffd333] text-[#1a1a1a] rounded-lg hover:bg-[#edc32f] transition font-semibold disabled:bg-gray-400 disabled:cursor-not-allowed",children:f?"Update":"Save"}),u&&o.jsx("span",{className:"ml-3 text-gray-500 text-sm",children:"Loading data..."})]})]}),o.jsx("style",{jsx:!0,children:`
