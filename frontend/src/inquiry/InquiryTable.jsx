                    ...
                    <div className="flex items-center gap-1 bg-gray-100 p-1 rounded-lg mt-4 w-fit">
                        <button 
                            ...
                            className={`px-6 py-2 rounded-md text-sm font-bold transition-all ${
                                activeTab === "Active" 
                                ? "bg-white text-[#7a6b00] shadow-sm" 
                            ...
                            <TableCell>
                                <div className="space-y-1">
                                    ...
                                    {expandedRowId === item._id && (
                                        <div className="mt-3 bg-gray-50 border border-gray-200 rounded-lg p-4 space-y-2.5 text-sm shadow-inner scale-in-95 animate-in fade-in duration-200">
                                            ...
                                            <div className="flex gap-3 border-b border-gray-200 pb-1.5">
                                                ...
                                                <span className="text-[#7a6b00] font-medium">{item.email}</span>
                                            </div>
                                    ...
                                    <button
                                        ...
                                        className="text-[#7a6b00] text-xs font-bold hover:underline focus:outline-none flex items-center gap-1 mt-2"
                                    >
                                        {expandedRowId === item._id ? (
