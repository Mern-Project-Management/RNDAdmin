...
export default function CallbackForm() {
  ...
  const InputField = ({ label, name, icon: Icon, type = "text", required = false, placeholder }) => (
    <div className="mb-6 group">
      <label className="block text-gray-800 text-sm font-semibold mb-1 group-focus-within:text-[#7a6b00] transition-colors">
        {label}{required && <span className="text-red-500 ml-1">*</span>}
      </label>
      <div className="relative border-b border-gray-200 group-focus-within:border-[#ead37a] transition-colors duration-300">
        <input
          required={required}
          name={name}
          type={type}
        ...
        />
        <div className="absolute right-0 top-1/2 -translate-y-1/2 text-gray-400 group-focus-within:text-[#7a6b00] transition-colors">
  ...
  return (
    <div className="mt-8 bg-white p-6 rounded-2xl shadow-lg border border-gray-50 relative overflow-hidden group">
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className="mb-6 group">
          <label className="block text-gray-800 text-sm font-semibold mb-1 group-focus-within:text-[#7a6b00]">
            Message/Service
          </label>
          <div className="relative border-b border-gray-200 group-focus-within:border-[#ead37a] transition-colors duration-300">
            <textarea
            ...
            />
            <div className="absolute right-0 top-3 text-gray-400 group-focus-within:text-[#7a6b00] transition-colors">
        ...
        <button
          type="submit"
          disabled={loading}
          className="w-full group flex items-center justify-between bg-gray-900 text-[#1a1a1a]-[#ffcc00] transition-all duration-300 active:scale-[0.98] disabled:opacity-50"
        >
