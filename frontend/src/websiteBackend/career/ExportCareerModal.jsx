...
export default function ExportCareerModal({ data }) {
    ...
    const handleExport = () => {
        ...
        const headers = ["Date", "Name", "Email", "Phone", "Post Applied For", "Address"];
        const csvRows = [];
        ...
        filteredData.forEach(item => {
            ...
            const row = [
                ...
                `"${(item.careerTitle || item.postAppliedFor || "").replace(/"/g, '""')}"`,
        ...
        link.setAttribute("download", `career_export_${new Date().getTime()}.csv`);
    ...
    return (
        <Dialog open={isOpen} onOpenChange={setIsOpen}>
            ...
            <DialogContent className="sm:max-w-[800px] h-[80vh] flex flex-col">
                <DialogHeader>
                    <DialogTitle>Export Career Applications to CSV</DialogTitle>
                </DialogHeader>
                    ...
                    <Table>
                        <TableHeader>
                            <TableRow>
                                ...
                                <TableHead>Post Applied For</TableHead>
                            </TableRow>
                        </TableHeader>
                        <TableBody>
                            {previewData.length > 0 ? previewData.map((item, idx) => {
                                ...
                                return (
                                    <TableRow key={idx}>
                                        ...
                                        <TableCell>{item.phone || item.contactNo}</TableCell>
                                        <TableCell>{item.careerTitle || item.postAppliedFor}</TableCell>
                                    </TableRow>
                                );
                            }) : (
                                <TableRow>
