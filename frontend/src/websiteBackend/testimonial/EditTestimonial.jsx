            ...
            <div className="mt-8 text-center">
                <button
                    ...
                    className={`${isLoading
                            ...
                            : 'bg-[#ffd333] hover:bg-[#edc32f]'
                        } text-[#1a1a1a] font-semibold py-2 px-6 rounded-lg flex items-center justify-center gap-2 transition duration-200 shadow-sm mx-auto`}
                >
                    {isLoading ? (
                        <>
